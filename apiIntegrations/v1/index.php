...
Flight::route('GET /getMyAlertsr/@headerslink/@profileId', function ($headerslink,$profileId) {
    ...
    if (!empty($apiKey) && !empty($xApiKey)) {
      ...
      curl_close($curl);
        ...
        if ($response1 != 'false' ) {
            ...
            // Realizar la solicitud y obtener la respuesta
            $response = file_get_contents($sub_domain.'/crystalIntegrations/apiControlTower/v1/getMyAlertsr/'.$profileId, false, $context);
...
Flight::route('GET /getAllPagesas/@headerslink', function ($headerslink) {
    ...
    if (!empty($apiKey) && !empty($xApiKey)) {
      ...
      curl_close($curl);
        ...
        if ($response1 != 'false' ) {
            ...
            // Realizar la solicitud y obtener la respuesta
            $response = file_get_contents($sub_domain.'/crystalIntegrations/apiControlTower/v1/getAllPagesas/', false, $context);
...
Flight::route('GET /getAllPagesModelsHislogs/@headerslink/@modelId/@sdate', function ($headerslink,$modelId,$sdate) {
    ...
    if (!empty($apiKey) && !empty($xApiKey)) {
      ...
      curl_close($curl);
        ...
        if ($response1 != 'false' ) {
            ...
            // Realizar la solicitud y obtener la respuesta
            $response = file_get_contents($sub_domain.'/crystalIntegrations/apiControlTower/v1/getAllPagesModelsHislogs/'.$modelId.'/'.$sdate, false, $context);
...
echo $response2." acá".Flight::request()->data->pageId;
...
$dt=json_encode($dta);
     ...
     $url1 = $sub_domain."/crystalIntegrations/apiControlTower/v1/editCredentials/$response1/$xapk";
    // $url1 = $sub_domain."/crystalIntegrations/apiControlTower/v1/postRooms1/$response1/$xApiKey";
