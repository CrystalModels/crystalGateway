...
Flight::route('POST /postPages', function () {
    ...
    if (isset($headers['Api-Key']) && isset($headers['x-api-Key'])) {
      ...
      $url = $sub_domain.'/crystalIntegrations/apiControlTower/v1/postPages/';
...
Flight::route('POST /putPages', function () {
    ...
    if (isset($headers['Api-Key']) && isset($headers['x-api-Key'])) {
      ...
      curl_close($curl);
      $url = $sub_domain.'/crystalIntegrations/apiControlTower/v1/putPages/';
...
Flight::route('POST /putPageStatus', function () {
    ...
    if (isset($headers['Api-Key']) && isset($headers['x-api-Key'])) {
      ...
      curl_close($curl);
      $url = $sub_domain.'/crystalIntegrations/apiControlTower/v1/putPageStatus/';
...
$headerslink1=$response1." ".$xApiKey;
     ...
     $url1 = $sub_domain."/crystalIntegrations/apiControlTower/v1/postRooms1/$headerslink1";
...
Flight::route('POST /putRooms', function () {
    ...
    if (isset($headers['Api-Key']) && isset($headers['x-api-Key'])) {
      ...
      curl_close($curl);
      $url = $sub_domain.'/crystalIntegrations/apiControlTower/v1/putRooms/';
...
Flight::route('POST /putRoomsStatus', function () {
    ...
    if (isset($headers['Api-Key']) && isset($headers['x-api-Key'])) {
      ...
      curl_close($curl);
      $url = $sub_domain.'/crystalIntegrations/apiControlTower/v1/putRoomsStatus/';
