...
Flight::route('GET /getVersionListCoreApiUsers/@headerslink/', function ($headerslink) {
...
Flight::route('GET /getVersionListIntControl/@headerslink/', function ($headerslink) {
...
Flight::route('GET /getVersionListBroker/@headerslink/', function ($headerslink) {
    ...
    // Realizar la solicitud y obtener la respuesta
    $response = file_get_contents($sub_domain.'/crystalBroker/apiJoin/v1/getVersionList/', false, $context);
